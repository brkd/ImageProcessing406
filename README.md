...
Note: please refer to the PDF file at https://github.com/brkd/ImageProcessing406/blob/master/CS406_Final_Report.pdf since this version lacks images.
...
4.5.GrayWorld
	...
	Gray World estimates the actual illuminant of the environment and changes the image to match that.
...
5.Results
*test results included in the pdf file*
