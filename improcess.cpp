...
int main(int argc, char** argv)
{
	...
	std::cout << "Reflection True: " << checkEquality(reflectedImage, parReflectedImage, height, width) << std::endl;
	if (writeOut == 1)
	{
	...
	std::cout << "Rotate90 True: " << checkEquality(rotated90Image, parRotated90Image, height, width) << std::endl;
	if (writeOut == 1)
	{
		matrixToFile(outFileName + "_seqRotate90.txt", rotated90Image, height, width);
		matrixToFile(outFileName + "_parRotate90.txt", parRotated90Image, height, width);
	}
	/*********************************ROTATE90 COMPARISON*********************************/
	...
	std::cout << "Rotate180 True: " << checkEquality(rotated180Image, parRotated180Image, height, width) << std::endl;
	if (writeOut == 1)
	{
	...
	std::cout << "Rotation270 True: " << checkEquality(rotated270Image, parRotated270Image, height, width) << std::endl;
	if (writeOut == 1)
	{
		matrixToFile(outFileName + "_seqRotate270.txt", rotated270Image, height, width);
		matrixToFile(outFileName + "_parRotate270.txt", parRotated270Image, height, width);
	}
	/*********************************ROTATE270 COMPARISON*********************************/
